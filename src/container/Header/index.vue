<template>
  <header class="header-container">
    <div class="grid">
            ...
            <ul class="header-container-top-wapper">
              ...
              <li class="header-container-top-wapper-item handle-model">
                ...
                <div class="model-download">
                  <div>
                    <img
                      src="../../assets/header-qr/qr.png"
                      class="model-qr-app-qr"
                    />
                    <div class="model-qr-apps">
                      <img
                        src="../../assets/header-qr/apstore.png"
                        class="model-qr-app-appstore header__qr-download-img"
                      />
                      <img
                        src="../../assets/header-qr/chplay.png"
                        class="model-qr-app-chplay header__qr-download-img"
                      />
                      <img
                        src="../../assets/header-qr/appgallery.png"
                        class="model-qr-app-appgallery header__qr-download-img"
                      />
                    </div>
                  </div>
                </div>
      ...
      <div class="header__ctn__body grid">
        <span>
          <svg viewBox="0 0 192 65" class="header__ctn__body__logo">
            <g fill-rule="evenodd">
              <path
                fill="#fff"
        ...
        <div class="header__seach">
          <input
            class="header__seach--input"
            :placeholder="hanldePlaceholder"
          />
          <button class="header__seach-icon">
            <i class="header__search-btn-icon fas fa-search"></i>
          </button>
        </div>
        <span class="header__shop__cart">
          <i
            class="fa-solid fa-cart-shopping header__shop__cart--icon"
            @mouseover="handlemouseoverCart"
            @mouseleave="hanldeMouseleaveCart"
          >
            <span>
              <models-vue
                v-if="isShowShopCart"
...
export default {
  ...
  setup() {
    ...
    const hanldeMouseleaveNotification = () => {
      isShowBell.value = false;
    };
    const handleMouseoverLanguage = () => {
      isShowLanguage.value = true;
    };
    const hanldeMouseleaveLangue = () => {
      isShowLanguage.value = false;
    };
    const handlemouseoverCart = () => {
      isShowShopCart.value = true;
    };
    const hanldeMouseleaveCart = () => {
      isShowShopCart.value = false;
    };
    const hanldePlaceholder = computed(() => {
...
.header-container {
  ...
  .header-container-top {
    .header-container-top-right {
      ...
      height: 3.4rem;
      .header-container-top-ctn {
        margin-left: -10px !important;
      }
      .header-container-top-wapper {
        display: flex;
